...
class TestLoginFromMainPage(): #объединим в группу два теста и пометим его меткой login_guest
...
# запуск с параметром и маркировкой pytest -m login_guest -s -v --language=en test_main_page.py